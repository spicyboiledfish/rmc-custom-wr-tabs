...
export var DefaultTabBar = function (_React$PureComponent) {
        ...
        _this.onPan = function () {
            ...
            return {
                ...
                onPanMove: function onPanMove(status) {
                    ...
                    var offset = lastOffset + (isVertical ? status.moveStatus.y : status.moveStatus.x);
    ...
    _createClass(DefaultTabBar, [{
        ...
        value: function render() {
            ...
            var underlineProps = {
                style: _extends({}, isTabBarVertical ? { height: size + '%' } : { width: 'auto' }, isTabBarVertical ? { top: size * activeTab + '%' } : { left: this.props.tabs[this.props.activeTab].leftValue + 'px' }, tabBarUnderlineStyle),
